...
echo "$($PSQL "SELECT DISTINCT(name) FROM teams FULL JOIN games a ON teams.team_id = a.winner_id FULL JOIN games b ON teams.team_id = b.opponent_id WHERE (a.year = 2014 OR b.year = 2014) AND (a.round = 'Eighth-Final' OR b.round = 'Eighth-Final')")"
